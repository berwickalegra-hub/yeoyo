...
// imported by tests. Uses pathToFileURL (not a template-string `file://`
// join) so this matches on Windows, where process.argv[1] is backslash-based
// and import.meta.url is a URL-encoded forward-slash file:// URL.
