// POST /api/credits/orders/[id]/verify-checkout — called by the Credits
// "pending" page while polling. Unlike a passive GET, this actively forces
// a re-pull of the real status from Chariow via reconcileChariowOrder, so a
// real payment confirms as fast as Chariow's own API responds instead of
// waiting for the webhook or the cron.
